...
const Feature = () => {
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-b to-c1 from-c2 flex flex-col items-center justify-center pb-8 pt-20 cursor-default'
      ...
      <div className='w-full h-auto flex justify-center gap-10 px-8'>

      {data.map((d,i)=>(
        <div key={i} className='w-2/12 h-auto bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 
